...
<?php
    ...
    $listarUp = new ListarUpBanner;
    $updateBanner = $listarUp->listarUp($_GET['id']);

    $dados = mysqli_fetch_assoc($updateBanner);
                    ...
                    <div class="col-md-12">
                        <div class="welcome2-inner m-t-60">
                            <div class="welcome2-greeting">
                                <h1 class="title-6">Olá
                                    <span><?php echo "$Snome";?></span>, Bem vindo de Volta</h1>
                                    ...
                                    <ul class="list-unstyled navbar__list">
                                        <li class="active has-sub">
                                            <a class="js-arrow" href="#">
                                                <i class="fas fa-tachometer-alt"></i>Actualizar
                                                <span class="arrow">
                        ...
                        <div class="col-xl-9">
                            ...
                            <div class="page-content">
                                ...
                                <div class="row">
                                    ...
                                    <form action ="../app/update_banner.php?id=<?php echo $_GET['id'];?>" method="POST" enctype="multipart/form-data">
                                   <center>
                                    <h1>Actualizar BANNER [<?php echo  $id; ?>] </h1>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" value="<?php echo $titulo;?>" required name="titulo" id="inputEmail4" placeholder="Titulo">
                                    </div>
                                    ...
                                    <div class="form-group">
                                    <label for="exampleFormControlFile1">Imagem Banner  </label><br>
                                    <input type="file" class="" required name="ficheiro" id="exampleFormControlFile1">
                                  </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="copyright">
                                            <p>gtwork <a href="https://colorlib.com">Colorlib</a>.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
