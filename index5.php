                                    ...
                                    <ul class="list-unstyled navbar__list">
                                        <li class="active has-sub">
                                            <a class="js-arrow" href="#">
                                                <i class="fas fa-tachometer-alt"></i>Dashboard 5
                                                <span class="arrow">
                        ...
                        <div class="col-xl-9">
                            ...
                            <div class="page-content">
                                ...
                                <div class="row">
                                    ...
                                    <form action ="../app/add_banner.php?info=add" method="POST" enctype="multipart/form-data">
                                   <center>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" required name="titulo" id="inputEmail4" placeholder="Titulo">
                                    </div>
